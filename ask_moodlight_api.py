...
def _load_market_context(engine) -> list:
    ...
    try:
        ...
        if not stk_df.empty:
            ...
            latest_date = pd.to_datetime(stk_df["snapshot_date"], utc=True).max()
