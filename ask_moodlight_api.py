...
- **The Global Creative Council:** Award-show entry strategist. Takes a case study and recommends which categories at which shows (Cannes, Effie, Clio, D&AD, One Show) give the work its best shot, grounded in jury-room experience and live cultural tailwind. Names a dark horse category and categories to avoid. Does NOT promise win probabilities — provides fit ranking with reasoning. Best inputs: a case study or work description + the brand/client + medium + eligibility year. Tailor Product/Service to the case study itself, Key Challenge toward award goals (e.g. "which Cannes categories for this pro-bono film" or "Effie fit check for an effectiveness case").
