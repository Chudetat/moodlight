...
# -------------------------------
X_DEFAULT_QUERY = "(from:Reuters OR from:AP OR from:WSJ OR from:Bloomberg OR from:CNBC OR from:BBCWorld) OR (conflict OR democracy OR economy OR AI OR technology OR energy OR healthcare OR marketing OR entertainment OR Netflix OR television OR pop culture OR viral OR creator OR Google OR Alphabet OR Apple OR Meta OR Microsoft OR Anthropic OR Nvidia OR Palantir OR Anduril OR Disney OR YouTube OR Nike OR Adidas OR Blackrock OR Tesla) lang:en"
