...
TOTAL_MAX_TWEETS = 1500  # Increased for PPU plan
TOTAL_MAX_NEWS = 400
...
# -------------------------------
X_DEFAULT_QUERY = "(from:Reuters OR from:AP OR from:WSJ OR from:Bloomberg OR from:CNBC OR from:BBCWorld) OR (conflict OR democracy OR economy OR infrastructure OR finance OR AI OR technology OR energy OR healthcare OR marketing OR entertainment OR Netflix OR television OR pop culture OR viral OR creator OR sports OR TikTok OR Google OR Alphabet OR Apple OR Meta OR Microsoft OR Amazon OR Anthropic OR Nvidia OR Palantir OR Anduril OR Disney OR YouTube OR Nike OR Adidas OR Blackrock OR Tesla) lang:en"

# High-engagement trending query - viral content only
X_TRENDING_QUERY = "(breaking OR developing OR just announced) lang:en"
...
TOPIC_KEYWORDS = {
    ...
    "qsr": ["fast food", "fast-food", "quick service", "quick-service", "qsr", "drive-thru",
        "drive thru", "drive-through", "fast casual", "fast-casual", "value meal", "combo meal",
        "happy meal", "dollar menu", "value menu", "food truck", "ghost kitchen", "food delivery",
        "doordash", "uber eats", "grubhub", "burger chain", "mcdonald's", "mcdonalds",
        "burger king", "wendy's", "wendys", "taco bell", "kfc", "chipotle", "starbucks", "dunkin",
        "chick-fil-a", "popeyes", "domino's", "dominos", "pizza hut", "wingstop", "shake shack",
        "panera", "sweetgreen", "dutch bros", "raising cane's", "raising canes", "whataburger",
        "in-n-out", "arby's", "arbys", "five guys", "culver's", "culvers", "panda express",
        "jimmy john's", "jimmy johns", "jack in the box", "hardee's", "hardees", "carl's jr",
        "del taco"],
}
