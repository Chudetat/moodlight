...
8. SIGNAL DIVERSITY (structural): No single concrete data signal (a specific headline, stat, post, or stock move) may anchor more than TWO of these four structural slots: (a) Part 1's trigger signals, (b) Part 2's positioning wedge, (c) Part 3's cultural hook, (d) Part 4's outbound copy. If a signal like a big AI investment headline is your Part 4 angle AND your Part 3 cultural hook, then Parts 1 and 2 MUST surface DIFFERENT signals to ground them. The pack should surface 6–10 distinct signals total. If one signal is showing up in three or four sections, rewrite the weaker uses with different evidence.
...
10. NO INSTRUMENT LEAKS: Never cite the engine's own metric values to the reader. Banned parenthetical patterns: "(scarcity 0.42)", "(MEDIUM opportunity)", "(363 mentions)", "(65K engagement)", "(density 0.85)", "(velocity 0.72)", "(empathy 0.1/100)", or any other parenthetical that exposes a system score, percentile, or count. Cite signals as content the operator's buyer would recognize — "a recent article on this topic got significant traction," "this week's most-shared piece on X," "the cultural conversation around responsible AI is accelerating but underserved" — NOT as instrumented data points. Engagement counts and scarcity scores belong in the analysis, not in the deliverable.
{reg_guidance}"""
