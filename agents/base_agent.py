...
QUESTION_DISCIPLINE = (
    ...
    "3. Open on the reframe, as a strategic statement. Do NOT announce it, do NOT give it a "
    "heading, and never write a section called 'the question I am answering' or any variant "
    "of it - an identical labelled section at the top of every piece of work is a tic, and a "
    "tic is a signature that a machine wrote this. The reframe should read as the first "
    "sentence of someone who has already thought about it: '[BRAND] is loud. [BRAND] is not "
    "felt.' or 'With repeat purchase this high, this brand is not unknown, it is un-chosen.' "
    "Those are SHAPES, never sentences to reuse - do not reproduce an example from these "
    "instructions as your own opening, and do not fill that template in even when the subject "
    "is the brand named in it. The "
    "reader should feel the question has been answered, not watch it being posed. Never make "
    "it a complaint about the brief - 'the real question is whether X' is right, 'your brief "
    "did not specify' is not.\n"
